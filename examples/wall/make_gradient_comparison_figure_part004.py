...
# camera-locking / shared-crop approach so both panels are guaranteed
# identical scale and centering.
...
DIAG_VTU = '../incoming_dataset/part004_LP400_SSp8_H1.12_SSt1_LH1.0/toolpath_arc_length_composition/composition_diagnostics.vtu'
OUT_DIR = '../incoming_dataset/part004_LP400_SSp8_H1.12_SSt1_LH1.0/toolpath_arc_length_composition'
CMAP = 'viridis'
CLIM = [0, 1]
...
out_path = OUT_DIR + '/global_x_vs_toolpath_gradient_part004.png'
