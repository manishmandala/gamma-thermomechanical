# Side-by-side composition-mapping figure for the hatch-spacing-study pilot
# (h=1.12mm, synthetic toolpath, part004's real mesh). Same pattern as the
# part002/part005/part004 comparison figures.
...
DIAG_VTU = '../incoming_dataset/part004_LP400_SSp8_H1.12_SSt1_LH1.0/hatch_spacing_study/pilot_h1.12/composition_diagnostics.vtu'
OUT_DIR = '../incoming_dataset/part004_LP400_SSp8_H1.12_SSt1_LH1.0/hatch_spacing_study/pilot_h1.12'
CMAP = 'viridis'
CLIM = [0, 1]

CAMERA_POSITION = (160.6976495586776, 160.6976495586776, 154.6976495586776)
CAMERA_FOCAL_POINT = (0.0, 0.0, -6.0)
...
ax.imshow(right_img)
ax.set_title('Toolpath-Following Gradient (Synthetic h=1.12mm)', fontsize=26, fontweight='bold', pad=16)
ax.axis('off')
...
out_path = OUT_DIR + '/global_x_vs_toolpath_gradient_pilot_h1.12.png'
