# Side-by-side composition-mapping figure for part001 (a flat bracket-like
# part with 4 mounting holes - a distinctly different geometry from
# part002's ring, part004's notched raster block, and part005's block+boss).
# Same camera-locking / shared-crop approach as every other dataset's
# comparison figure in this project.
...
DIAG_VTU = '../incoming_dataset/part001_LP500_SSp8_H1.12_SSt4_LH0.8/toolpath_arc_length_composition/composition_diagnostics.vtu'
OUT_DIR = '../incoming_dataset/part001_LP500_SSp8_H1.12_SSt4_LH0.8/toolpath_arc_length_composition'
CMAP = 'viridis'
CLIM = [0, 1]

CAMERA_POSITION = (159.54941431297638, 159.54941431297638, 150.5994143129764)
CAMERA_FOCAL_POINT = (0.0, 0.0, -8.95)
...
out_path = OUT_DIR + '/global_x_vs_toolpath_gradient_part001.png'
